const temperature = document.querySelector(".input-side input");
const result = document.querySelector(".output-side input");
const inputTemperatureUnit = document.querySelector(".input-side select");
const resultTemperatureUnit = document.querySelector(".output-side select");
